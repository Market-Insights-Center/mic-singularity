...
async def handle_ai_prompt(user_new_message: str, is_new_session: bool = False, original_session_request: Optional[str] = None):
    ...
    try:
        all_gemini_tools = Tool(function_declarations=[
            ...
            get_comparison_custom_portfolio_tool
            # Add other FunctionDeclaration objects here if you have more tools
        ])
    ...
    max_internal_turns = 7 # Max tool calls + final summary attempt
