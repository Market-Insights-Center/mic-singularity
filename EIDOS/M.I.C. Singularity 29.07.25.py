...
Version History:
First Version: Core - 07/05/2025 to 25/07/25
Second Version: Edios - 26/07/25 to Present                          
...
def display_commands():
    ...
    command_lines.append("\nTIME Commands")
    command_lines.append("-------------------")
    command_lines.append("/macdforecast - Forecasts stock price based on MACD CTC analysis.")
